    ...
    if (memo.attachments && memo.attachments.length > 0) {
      ...
      memo.attachments.forEach((resource) => {
        ...
        if (/\.(mp4|mpg|mkv|mp3)/i.test(resource.filename)) {
          ...
          const medialink = "/files/2025/" + resource.filename;
        ...
        if (/\.(jpeg|jpg|gif|png|bmp|webp|svg|avif)/i.test(resource.filename)) {
          ...
          img.src = "/files/2025/" + resource.filename;
          ...
          fancyboxlink.href = "/files/2025/" + resource.filename;
          ...
          rlink.href = "/files/2025/" + resource.filename;
